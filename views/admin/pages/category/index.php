<div class="card-body px-4 py-0">
    <div class="my-3 d-flex justify-content-between">
        ...
        <a href="/admin/category-create" class="text-decoration-none text-white bg-danger rounded p-2">+ Thêm danh mục</a>
    </div>
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex justify-content-between align-items-center">
            <input type="search" class="p-2 rounded border-0 w-100 mr-2 " placeholder="Tìm kiếm danh mục">
    ...
    <div class="table-responsive mt-4">
                            ...
                            <td>
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="/admin/category-update/<?= $item['id'] ?? '' ?>" class="text-danger btn">Sửa</a>
                                    </div>
                                    <div class="d-flex align-items-center">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-footer flex-nowrap">
                                        ...
                                        <form action="/admin/category-destroy/<?= $item['id'] ?? '' ?>" method="post" class="d-flex align-items-center">
        ...
        <?php
        $totalProducts = count($categories);
        $productsPerPage = 5;
        ...
        $displayedProducts = array_slice($categories, $offset, $productsPerPage);
        ?>
