<div class="card-body px-4 py-0">
    <div class="my-3 d-flex justify-content-between">
        ...
        <a href="/admin/product-create" class="text-decoration-none text-white bg-danger rounded p-2">+ Thêm sản phẩm</a>
    </div>
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex justify-content-between align-items-center">
            <input type="search" class="p-2 rounded border-0 w-100 mr-2 " placeholder="Tìm kiếm sản phẩm">
            <button class="text-nowrap bg-primary text-white p-2 rounded border-0 mr-2" id="sort-asc-btn">Giá tiền tăng</button>
            <button class="text-nowrap bg-primary text-white p-2 rounded border-0 mr-2" id="sort-desc-btn">Giá tiền giảm</button>
    ...
    <div class="table-responsive mt-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-column">
                                    <p class="my-1 text-danger">Giảm còn: <?= number_format($item['sale_price'], 0, ',', '.') ?? '' ?>đ</p>
                                    <p class="my-1 text-secondary">Góc: <?= number_format($item['price'], 0, ',', '.') ?? '' ?>đ</p>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="/admin/product-update/<?= $item['id'] ?? '' ?>" class="text-danger btn">Sửa</a>
                                    </div>
                                    <div class="d-flex align-items-center">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-footer flex-nowrap">
                                        ...
                                        <form action="/admin/product-destroy/<?= $item['id'] ?? '' ?>" method="post" class="d-flex align-items-center">
        ...
        $displayedProducts = array_slice($products, $offset, $productsPerPage);
        ?>
