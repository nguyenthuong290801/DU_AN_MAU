<div class="card-body px-4 py-0">
    <div class="my-3 d-flex justify-content-between">
        ...
        <a href="/admin/attribute-create" class="text-decoration-none text-white bg-danger rounded p-2">+ Thêm thuộc tính</a>
    </div>
                            ...
                            <td>
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="/admin/attribute-update/<?= $item['id'] ?? '' ?>" class="text-danger btn">Sửa</a>
                                    </div>
                                    <div class="d-flex align-items-center">
