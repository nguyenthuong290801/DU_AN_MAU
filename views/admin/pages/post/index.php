<div class="card-body px-4 py-0">
    <div class="my-3 d-flex justify-content-between">
        ...
        <a href="/admin/post-create" class="text-decoration-none text-white bg-danger rounded p-2">+ Thêm bài viết</a>
    </div>
                            ...
                            <td>
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="/admin/post-update/<?= $item['id'] ?? '' ?>" class="text-danger btn">Sửa</a>
                                    </div>
                                    <div class="d-flex align-items-center">
