<div class="card-body px-4 py-0">
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex justify-content-between align-items-center">
            <input type="search" class="p-2 rounded border-0 w-100 mr-2 " placeholder="Tìm kiếm người bình luận">
    ...
    <div class="table-responsive mt-4">
        <table class="table table-dark text-center mb-4">
            ...
            <tbody>
                <?php $i = 1; ?>
                <?php if (isset($cmts)) : ?>
                    <?php foreach ($cmts as $item) : ?>
                        <tr>
                            <td><input type="checkbox" class="product-check"></td>
                            <td> <?= $i ?> </td>
                            <td class="text-secondary"> <?= $item['comment_name'] ?? '' ?> </td>
                            <td class="text-secondary"> <?= $item['review'] ?? '' ?> </td>
                            <td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-footer flex-nowrap">
                                        ...
                                        <form action="/admin/product-cmt/<?= $item['id'] ?? '' ?>" method="post" class="d-flex align-items-center">
        ...
        $displayedProducts = array_slice($cmts, $offset, $productsPerPage);
        ?>
